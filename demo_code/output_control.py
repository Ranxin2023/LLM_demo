...
def top_p_sampling():
    ...
    temperature=1.0
    max_tokens=60
    response=query_open_ai(model_name=model_name, prompt=prompt, temperature=temperature, top_p=top_p, max_tokens=max_tokens)
    print("Top-P Sampling Output:", response)
